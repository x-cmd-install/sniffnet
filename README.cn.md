...
![sniffnet](https://repo.x-cmd.io/sniffnet.svg?lang=zh)
...
合计: **29,803** 行代码（覆盖前 5 种语言、共 **448** 个文件）。
...
- **最新版本**: `v1.5.1` (2026-07-22)
- **最近提交**: 2026-09-07
- **Release 含资产**: 15 个

## 流行度

- **Star**: 41,089 · **Fork**: 1,964 · **开放 issue**: 372 · **贡献者**: 76

## 累计统计

- **发布数**: 18 · **已合并 PR**: 561 · **开放 PR**: 11 · **已关闭 issue**: 318 · **开放 issue**: 54 · **提交数**: 3138

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 0 | 15 | 6 | 2 | 2 | 78 |
| last60d | 2026-07-14 | 1 | 21 | 7 | 8 | 2 | 131 |
| 90d | 2026-06-14 | 1 | 32 | 9 | 14 | 2 | 152 |
| last180d | 2026-03-16 | 2 | 66 | 10 | 41 | 13 | 262 |
| 360d | 2025-09-17 | 3 | 113 | 11 | 59 | 28 | 537 |
| last720d | 2024-09-22 | 6 | 249 | 11 | 141 | 42 | 1345 |
...
在 [repology.org](https://repology.org/project/sniffnet) 上共有 **36** 个发行版报告此项目。**26** 个 ✅ 已是最新上游版本，**9** 个 ⚠️ 使用旧版本。
...
sniffnet 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `sniffnet` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/sniffnet.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:53:54Z._
